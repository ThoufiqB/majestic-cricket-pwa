...
export function PlayerCard(p: Props) {
  ...
  return (
    <Card className={`transition-all ${r.attended ? "border-green-200 bg-green-50/30 dark:bg-green-950/10" : ""}`}>
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              ...
              {savingThis && <Loader2 className="h-4 w-4 animate-spin text-primary" />}
            </div>
